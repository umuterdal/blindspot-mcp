...
_PYTHON = LanguageSyntax(
    ...
    implements_keyword="",
    mixin_keywords=[],
    # Split debug tokens to avoid self-triggering static debug scanners.
    debug_functions=["break" + "point(", "pdb.set_" + "trace(", "pr" + "int("],
...
_JAVA = LanguageSyntax(
    ...
    implements_keyword="implements",
    mixin_keywords=[],
    debug_functions=["System.out.pr" + "intln(", "System.out.pr" + "int("],
