...
from .blade_strategy import BladeParsingStrategy
...
class StrategyFactory:
    ...
    def _initialize_strategies(self):
        ...
        with self._lock:
            ...
            try:
                ...
                blade_strategy = BladeParsingStrategy()
                self._strategies['.blade.php'] = blade_strategy
    ...
    def get_strategy(self, file_extension: str, file_path: str = "") -> ParsingStrategy:
        """
        Get appropriate strategy for file extension.

        Args:
            file_extension: File extension (e.g., '.py', '.js')
            file_path: Full file path (used for compound extensions like .blade.php)
        ...
        with self._lock:
            ...
            if file_path and file_path.endswith('.blade.php'):
                if '.blade.php' in self._strategies:
                    return self._strategies['.blade.php']
